          ...
          <div className="bg-white shadow-xl rounded-xl overflow-hidden border border-gray-200">
            <div className="p-4 sm:p-6 bg-gradient-to-r from-blue-600 to-teal-500 text-white">
              <h2 className="text-base sm:text-lg font-semibold flex items-center">
                ...
                Add Veterinary Facility
              </h2>
              <p className="text-blue-100 text-xs sm:text-sm mt-1">Enter the details of the new veterinary facility</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-5 sm:space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                ...
                <div className="col-span-1 md:col-span-2">
                  <label htmlFor="facilityName" className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">
                ...
                {/* Facility Type */}
                <div className="col-span-1 md:col-span-2">
                  <label htmlFor="facilityType" className="block text-xs sm:text-sm font-medium text-gray-700 mb-1">
