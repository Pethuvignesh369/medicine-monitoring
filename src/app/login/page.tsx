...
function LoginForm() {
  ...
  // We'll handle logout parameters on component mount instead of using useSearchParams
  useEffect(() => {
    ...
    if (logout === 'true') {
      // Make sure we're logged out by clearing any remaining auth data
      ...
      console.log("Login page - Cleared all auth data after logout");
    }
  }, []);
